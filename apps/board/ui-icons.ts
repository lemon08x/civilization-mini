...
export const placeIcon=(page:string)=>uiIcon(({聚落:'home',农业:'plant',生活:'plant',家人:'people',仓库:'box',学科:'book',产品:'tool',生产:'tool',系统:'tool',雇佣:'people',家业:'home',商城:'market',能源:'power',社会:'book'} as Record<string,string>)[page]??'tool');
