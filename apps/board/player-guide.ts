...
export function playerGroups(g:SessionObservation['game']):PlayerGroup[] {
  ...
  const groups:PlayerGroup[]=[
    ...
    {name:'生活与家人',pages:['农业','生活','家人','仓库'],description:'种田、补给、养育与传承',epigraph:'田里有收成，家里才有下一季。'},
...
export function ruleGuide(g:SessionObservation['game'],page:string):string {
  ...
  const guides:Record<string,[string,string][]>={
    社会:[['何时结算','由你决定。点“结算当前社会”会结束本季、推算剩余时间并进入下一段。水井和泵不是过关条件。到期仍会结算，但只兑实际生产。'],['社会服务','每个时代提供不靠科技树的公共服务：农业有公地采食和帮工，集镇有公井，工业有公共磨坊和铁/电工市场，现代有配送和自来水。'],['科技开放','部分课程要社会发展后才出现。已学会的知识继续生效。'],['收益归属','凭证只在本阶段兑现。后期自来水不会追溯取消前期水井的价值。最终副本只影响现代阶段的胜负，不是离开现代的条件。']],
