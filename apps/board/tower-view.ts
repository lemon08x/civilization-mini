...
export function towerPage(observation:SessionObservation,button:(id:string)=>string):string{
 ...
 <details><summary>采购与生产安排</summary><p>工地供货不会直接买材料。可先自行生产或采购；如果已开启家业自动补货，它也会购买商城可售的本层物资，非卖品仍需制造，并计入现场、运输和市场订单。施工口粮须由家庭余粮供应，供粮协议仍沿用家庭目标。自动销售会保留已安排给工地的物资。</p><button data-page="作坊">管理作坊</button><button data-page="生产">查看加工配方</button><button data-page="家业">管理家业</button><button data-page="商城">采购物资</button></details>
