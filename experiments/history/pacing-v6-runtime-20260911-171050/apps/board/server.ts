...
const server = http.createServer(async (req, res) => {
  ...
  try {
    ...
    else if (['/rulesets/traditional-agriculture.v1.json', '/rulesets/shared-production.v2.json', '/rulesets/technology-feedback.v3.json', '/rulesets/social-inheritance.v4.json', '/rulesets/craft-science.v5.json', '/rulesets/product-network.v6.json'].includes(path)) absolute = join(projectRoot, path.slice(1));
