...
export interface FarmPlot {id:string;x:number;y:number;kind:'unknown'|'wild'|'field'|'home'|'tree'|'rock'|'brush'|'story';field?:Field;discovery?:{id:FarmDiscovery;resolved:boolean;outcome:string};fertility?:number;}
