...
export const BRANCH_NODES:BranchNode[]=[
  ...
  {id:'M1',name:'成形与连接',subject:'materials',unlockEra:1,parents:['M0'],sample:{wood:1},benefit:'锻打工具与部件连接；集镇以后开放'},
  ...
  {id:'M4',name:'电工绝缘',subject:'materials',unlockEra:2,parents:['M0'],sample:{wood:1,clay:1},benefit:'认识绝缘，联络电工材料商；工业城镇以后开放'},
  ...
  {id:'L1',name:'机械传动',subject:'mechanics',unlockEra:1,parents:['L0'],sample:{wood:1},benefit:'传动轴、手摇传动与磨粮；集镇以后开放'},
  {id:'L2',name:'压力与流体',subject:'mechanics',unlockEra:1,parents:['L0'],sample:{clay:1},benefit:'阀门与流体基础，不必先学机械传动'},
  {id:'L3',name:'泵与供水',subject:'mechanics',unlockEra:1,parents:['L2'],sample:{wood:1},benefit:'制造活塞泵。集镇公井不要求先学泵'},
  {id:'L4',name:'水力动力',subject:'mechanics',unlockEra:2,parents:['L1'],sample:{wood:1},benefit:'水轮动力；工业城镇以后开放'},
  ...
  {id:'O1',name:'生产工序',subject:'organization',unlockEra:1,parents:['O0'],sample:{wood:1},benefit:'工匠持续生产与农业托管；集镇以后开放'},
...
export const ERA_NODES:BranchNode[]=[
 ...
 {id:'Q1',name:'应用数学',subject:'mechanics',unlockEra:1,parents:['Q0'],sample:{},benefit:'本人加工少1精力；最终副本可提供方案验算。集镇以后开放。'},
 {id:'Q2',name:'账目与计量',subject:'mechanics',unlockEra:1,parents:['Q0'],sample:{},benefit:'阶段生产核算的数量前置。集镇以后开放。'},
 {id:'A2',name:'井渠作业',subject:'agronomy',unlockEra:0,parents:['A1'],sample:{},benefit:'建设家庭水井。不是离开农业的条件；已建井跨社会保留。'},
 {id:'O3',name:'集镇生产核算',subject:'organization',unlockEra:1,parents:['Q2','O0'],sample:{},benefit:'本家庭实际生产的阶段回报凭证增加四分之一。与另外两门核算课不叠乘。集镇以后可学。'},
 {id:'O4',name:'工厂批次管理',subject:'organization',unlockEra:2,parents:['Q2','O1'],sample:{},benefit:'本家庭实际生产的阶段回报凭证增加四分之一。工业城镇以后可学。'},
...
export function nodeInEra(s:{era?:{index:number}},id:string):boolean{if(!s.era)return true;return s.era.index>=nodeUnlockEra(id);}
