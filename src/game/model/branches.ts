...
export const BRANCH_PATHS=[
  {id:'farm',name:'农场 · 栽培与水土',nodes:['A0','A1','A2','A3','A4'],products:['W01'],description:'种植、肥力、井渠与新种子；探索和留种在田地进行。'},
...
export const COURSE_TRACKS:Record<string,{name:string;nodes:string[];use:string}>={
 cultivation:{name:'栽培与水土',nodes:['A0','A1','A2','A3','A4'],use:'农场 · 田地与探索'},
 supplies:{name:'提水与储粮',nodes:['M0','M3','L0'],use:'农场 · 储粮与简单提水工具'},
