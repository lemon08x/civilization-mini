...
export function branchActionNeeds(s:GameState,id:string):string[]{
  ...
  if(s.economy.farm&&['cook','farmproject','farmrare','farmstory','farmplot','farmexplore','farmreclaim','farmfertilize','pit','floodgate','plotplan','wildharvest','neighbor'].includes(op))return [];
