...
export function branchActionNeeds(s:GameState,id:string):string[]{
  ...
  if(['branchlearn','branchteach','brancharchive','channel','rest','care','retire','end','cartadd','cartremove','clearcart','checkout','gather','work','sell','sellfood','repair','finish','resumeplans','pause','fertilize','farmcycle'].includes(op))return [];
